...
public class IntakeSubsystem extends TestableSubsystem {
  ...
  DigitalOutput LinearActuator = new DigitalOutput(0);
  boolean deployed = false;
  TalonFX rollers = new TalonFX(0);
  ...
  public void intake(int value)
  {
    
  }

  public void actuatorToggle()
  {

    LinearActuator.set(!deployed);
    deployed = !deployed;
